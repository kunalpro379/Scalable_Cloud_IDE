...
export declare class WebSocketHandler implements WebSocketInterface {
    ...
    readonly socketFactory?: ((uri: string, protocols: string[], opts: WebSocket.ClientOptions) => WebSocket.WebSocket) | undefined;
    ...
    static restartableHandleStandardInput(createWS: () => Promise<WebSocket.WebSocket>, stdin: stream.Readable, streamNum?: number, retryCount?: number): () => WebSocket.WebSocket | null;
    constructor(config: KubeConfig, socketFactory?: ((uri: string, protocols: string[], opts: WebSocket.ClientOptions) => WebSocket.WebSocket) | undefined, streams?: StreamInterface);
    /**
